    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        <div class="grid  gap-4 mb-4">
            <div class="flex items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-800">
                <p class="text-2xl font-semibold text-purple-700 dark:text-gray-500">Hello Admin!!!</p>
            </div>
        </div>
       <div class="grid grid-cols-3 gap-4 mb-4">
          <div class="flex items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-800">
             <p class="text-2xl  dark:text-gray-500">
                ...
                <div class="block px-4 py-1">
                    <p class="font-bold text-xl">Total Employees </p>
                    <p  class="font-semibold text-xl">{{ $totalEmployees }}</p>
                </div>
          </div>
          <div class="flex items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-800">
                <p class="text-2xl dark:text-gray-500">
                ...
                <div class="block px-4 py-1 items-center justify-center">
                    <p class="font-bold text-xl">Total Departments  </p>
                    <p  class="font-semibold text-xl">{{ $totalDepartments }}</p>
              </div>
          ...
          <div class="flex items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-800">
             <p class="text-2xl dark:text-gray-500">
                ...
                <div class="block px-4 py-1 items-center justify-center">
                        <p class="font-bold text-xl">Employees Checked In Today </p>
                        <p  class="font-semibold text-xl">{{ $checkedInToday }}</p>
                </div>
          </div>
       </div>
