                ...
                <form class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div class="col-span-2 relative">
                        ...
                        <div class="flex items-center">
                            <input type="password" class="w-2/3 bg-white border p-2 pr-10 rounded-md border-gray-300 focus:border-custom-blue focus:ring-custom-blue" placeholder="Enter old password" id="oldPassword">
                    ...
                    <div class="col-span-2 relative">
                        ...
                        <div class="flex items-center">
                            <input type="password" class="w-2/3 bg-white border p-2 pr-10 rounded-md border-gray-300 focus:border-custom-blue focus:ring-custom-blue" placeholder="Enter new password" id="newPassword">
                    ...
                    <div class="col-span-2 relative">
                        ...
                        <div class="flex items-center">
                            <input type="password" class="w-2/3 bg-white border p-2 pr-10 rounded-md border-gray-300 focus:border-custom-blue focus:ring-custom-blue" placeholder="Confirm new password" id="confirmPassword">
